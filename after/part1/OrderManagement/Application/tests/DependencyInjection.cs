...
public static class DependencyInjection
{
    ...
    {
        var actorProvider = new TestActorProvider("test-user",
        ...
        services.AddResourceAuthorization(typeof(CancelOrderCommand).Assembly, typeof(FakeCancelOrderResourceLoader).Assembly);
        return services;
    }
}
