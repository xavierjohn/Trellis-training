...
/// <summary>Raised when an order is returned.</summary>
public sealed record OrderReturnedEvent(OrderId OrderId, CustomerId CustomerId, ReturnReason ReturnReason, DateTime ReturnedAt) : IDomainEvent
{
    public DateTime OccurredAt => ReturnedAt;
}
