...
public record OrderResponse
{
    ...
    /// <summary>Date and time the order was delivered, if applicable.</summary>
    public DateTime? DeliveredAt { get; init; }

    /// <summary>Date and time the order was returned, if applicable.</summary>
    ...
    public static OrderResponse From(Order order) => new()
    {
        ...
        DeliveredAt = order.DeliveredAt.Match<DateTime?>(d => d, () => null),
        ReturnedAt = order.ReturnedAt.Match<DateTime?>(d => d, () => null),
